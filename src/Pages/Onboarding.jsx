...
fill: #484848;
  ...
  <div className="flex flex-col items-start gap-10 py-0 px-20">
    <div className=" w-[609px] text-black font-['Readex text-[2.6875rem] font-light leading-[normal]">At AQF, we wholeheartedly believe in the power of conversation. </div>
