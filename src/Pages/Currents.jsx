  ...
  return (
    <div className="flex min-h-screen space-x-1 bg-black ">
      <div className="bg-[#FFD1AA] w-[36%] rounded-r-2xl">
        ...
        >
          {CurrentChallengeFlow.map((questions, key) => {
            if (key === state) {
              return (
                <>
                  ...
                  {key > 0 && (
                    <>
                      <div className="big h-[380px] mt-4 w-[310px] flex  items-center justify-center  bg-white rounded-lg border-black border-[3px] font-[Readex Pro] text-xl ">
                        <ul className="bullet flex flex-col items-center  list-disc justify-center h-full w-[210px]  space-y-4">
                          {questions?.prompt1 && (
...
const CurrentChallengeFlow = [
  ...
  },
  {
    ...
    prompt1: "What triggered these uncomfortable feelings?",
    prompt2: "What was I thinking when this occurred?",
  },
  {
    key: 2,
    title: "Describe the situation",
    prompt1: "What event took place, where and when?",
    prompt2: "Were there others involved?",
    prompt3: "Did you notice anything in particular during this? ",
  },
  {
    key: 3,
    title: "Different perspectives",
    prompt1:
      "Do you have any assumptions about what has happened or will happen?",
    prompt2: "What kind of situation would you like to feel more comfortable?",
  },
  {
    key: 4,
    title: "Take another look at your situation",
    prompt1: "How does naming our assumptions change your understanding?",
    prompt2: "How could this understanding help you for the future?",
  },
  {
    key: 5,
    title: "Growing with your story",
    prompt1: "What have you learned through this storytelling?",
  },
  {
    key: 6,
